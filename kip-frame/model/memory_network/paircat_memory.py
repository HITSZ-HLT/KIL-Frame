...
class paircat_memory(base_model):
    def __init__(self, mem_slots, input_size, output_size, key_size, head_size, num_heads=4):
        ...
        # first projector 768*2 -> 768
        self.m_projector = nn.Linear(input_size*2, input_size)
    ...
    def attention_over_memory(self, input, memory):
        ...
        ## 768*2->768
        memory = self.m_projector(memory)
